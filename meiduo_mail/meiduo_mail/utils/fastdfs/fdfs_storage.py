...
class FastDFSStorage(Storage):
    ...
    def __init__(self, client_path=None, base_url=None):
        ...
        self.client_path = client_path or get_tracker_conf('/home/frank/Desktop/pycharm/projects/meiduo2/meiduo_mail/meiduo_mail/utils/fastdfs/client.conf')
        # storage服务器ip:端口
